...
def train_model():
    ...
    # In ConvNeXt, the head is model.classifier[2]
    ...
    # ConvNeXt divides layers into 'features' (blocks 0-7) and 'classifier'
    optimizer = optim.Adam([
        {'params': model.features[0:4].parameters(), 'lr': 1e-6}, # Stem + early stages
        {'params': model.features[4:].parameters(),  'lr': 1e-5}, # Deep stages
